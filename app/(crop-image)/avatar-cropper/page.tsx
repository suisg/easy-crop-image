  ...
  const jsonLd = [
    {
      ...
      "@type": "WebApplication",
      "name": "EasyCrop - Free Online Avatar Cropper",
      "url": "https://www.easycropimage.com/avatar-cropper",
      "description": "Crop avatars for Discord, PFP, and social media with our free online avatar cropper. Resize, adjust, and preview profile pictures in real-time without losing quality.",
      ...
      "featureList": [
        "Fixed Crop Frames - Choose Circle, Square, or Both",
        "Real-Time Previews - Preview in four sizes as you adjust",
        "Zoom & Drag Controls - Precise cropping within fixed frame",
        "High-Quality Output - Download in PNG format without quality loss",
        "Completely Free - No sign-up required",
        "Optimized for Discord and PFP - Perfect profile picture dimensions"
      ],
      "publisher": {
        "@type": "Organization",
        "name": "EasyCrop",
    ...
    },
    {
      ...
      "name": "Avatar Cropper Tool",
      "description": "Free online tool to crop avatars and profile pictures for Discord, social media, and PFP with real-time previews and multiple frame options.",
      "url": "https://www.easycropimage.com/avatar-cropper",
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "HowTo",
      "name": "How to Crop an Avatar for Discord and Social Media",
      "description": "Learn how to crop a perfect Discord or PFP avatar using our free online cropping tool. Create profile pictures that fit any platform with real-time previews.",
      "totalTime": "PT2M",
      "estimatedCost": {
        "@type": "MonetaryAmount",
        "currency": "USD",
      ...
      "step": [
        {
          ...
          "text": "Select and upload your photo to our cropping tool. All image formats are supported for maximum compatibility."
        },
        {
          "@type": "HowToStep", 
          "position": 2,
          "name": "Choose Your Frame",
          "text": "Pick Circle, Square, or Both to crop your avatar. Choose the format that best fits your platform requirements."
        },
        {
          "@type": "HowToStep",
          "position": 3, 
          "name": "Adjust & Resize",
          "text": "Zoom, drag, or resize your photo to fit the fixed frame with real-time previews in four different sizes to ensure perfect positioning."
        },
        {
          "@type": "HowToStep",
          "position": 4, 
          "name": "Download",
          "text": "Save your cropped avatar in PNG format, ready for Discord, Twitter, or any platform. High-quality output without losing image quality."
        }
      ]
    }
  ];
